...
public class BinarySearchTreeProblems {
	...
	public static void printNodesOfSameLevel(BTNode root, int level, int currentLevel)
	{
		...
		if(level == currentLevel) System.out.println(root.value);
	...
	public static void reverseLevelOrderTraversal(BTNode node)
	{
		...
		while(!q.isEmpty())
		{
			...
			if(temp.right != null) {
				q.add(temp.right); nextLevel ++;
			}

			if(temp.left != null) 
			{
				q.add(temp.left); nextLevel++;
			}
	...
	{
		if(n==null) return min_so_far;

		if(n.value == k)
		{
			if(n.left == null) return min_so_far;
			BTNode left = n.left;
	...
	public static void printLeft(BTNode root)
	{
		...
		do
		{
			...
			{
				BTNode n = cQ.remove();
				if(n.left!=null) nQ.add(n.left);
				if(n.right != null) nQ.add(n.right);
			...
			{
				BTNode n = nQ.remove();
				if(n.left!=null) cQ.add(n.left);
				if(n.right!=null) cQ.add(n.right);
			}
	...
	public static void printRight(BTNode root)
	{
		...
		do
		{
			...
			{
				BTNode n = cs.pop();
				if(n.left!=null) ns.add(n.left);
				if(n.right != null) ns.add(n.right);
			...
			{
				BTNode n = ns.pop();
				if(n.left!=null) cs.add(n.left);
				if(n.right!=null) cs.add(n.right);
			}
	...
	public static boolean isSubTree(BTNode a,BTNode b)
	{
		...
		if(a.value==b.value) return equals(a, b);
	...
	public static BTNode commonAncestor(BTNode root,BTNode a,BTNode b)
	{
		...
		if(is_a_left!=is_b_left) return root;
	...
	public static BTNode insert(BTNode parent,int value)
	{
		...
		//If the value to be inserted is less than parent node, then insert it as the left child
	...
	public static BTNode delete(int value,BTNode parent)
	{
		...
		}else parent = (parent.right!=null) ? parent.right:parent.left;
